...
private void inicializarParaNuevoBus() {
   ...
   public void setDatosBus(int idBus, String placa, int capacidad, String estado) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(470, 170, 220, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel4.setText("Estado:");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(430, 350, 120, 17);

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel5.setText("Nro de Bus:");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(430, 220, 100, 17);
        ...
        btnCancelar.setBounds(590, 460, 180, 30);

        btnGuardarBus.setBackground(new java.awt.Color(0, 60, 241));
        ...
        btnGuardarBus.setBounds(370, 460, 180, 30);

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel6.setText("Capacidad:");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(430, 310, 120, 20);
        jPanel1.add(txtPlaca);
        txtPlaca.setBounds(550, 260, 140, 22);
        ...
        jTextField2.setBounds(390, 140, 340, 290);
