 ...
 */
public class ItinerarioDeViajesPorBuses extends javax.swing.JFrame {

    /**
     * Creates new form Login
     */
    public ItinerarioDeViajesPorBuses() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Itinerario", "Viajes Programado", "Asientos Asignados", "Costo"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(240, 210, 600, 230);

        jLabel3.setFont(new java.awt.Font("Segoe UI", 3, 36)); // NOI18N
        jLabel3.setText("Itinerario de Viajes por Bus");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(220, 140, 480, 70);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItinerarioDeViajesPorBuses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ItinerarioDeViajesPorBuses().setVisible(true);
            }
        });
    }
